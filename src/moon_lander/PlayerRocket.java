...
public class PlayerRocket {
	...
	private final int SOUND_MOTOR  = 3; // motor sound flag
    ...
    private boolean soundPlayed_landed = false;
    private boolean soundPlayed_motor = false;
    
    
    public PlayerRocket(int level)
    {
        Initialize(level);
        LoadContent();
    ...
    public void Draw(Graphics2D g2d)
    {
        ...
        if(landed)
        {
            ...
            if (soundPlayed_landed == false) {
            	this.playit(SOUND_LANDED);
            	soundPlayed_landed = true;
            }
        }
	...
	public void playit(int soundRequired) {
		...
		case SOUND_CRASH:
			fn = "./src/moon_lander/resources/sounds/snif.wav";
			break;
		case SOUND_LANDED:
			fn = "./src/moon_lander/resources/sounds/applause.wav";
			break;
		case SOUND_MOTOR:
			fn = "./src/moon_lander/resources/sounds/motor.wav";
			break;
		default:
			break;
