    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Use UP, LEFT and RIGHT keys to controle the rocket.", frameWidth / 2 - 167, frameHeight / 2);
                g2d.drawString("Press 1 for EASY level, 2 for MEDIUM level and 3 for HARD level", frameWidth / 2 - 200, frameHeight / 2 + 30);
                g2d.drawString("Pokhunter Corp.", 7, frameHeight - 5);
            break;
            case OPTIONS:
                //...
            break;
